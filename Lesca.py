...
# p = ''.join(random.choice(characters) for _ in range(10240))
...
with open("test_case.txt", "ab") as f: # A file named 'test_case.txt' will be created (if not already) in 'append binary' mode
